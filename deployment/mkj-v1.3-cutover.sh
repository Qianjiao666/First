...
artifact=/root/MKJ-community-forum-tasks-20260816-static-v1.3.zip
checksum=/root/MKJ-community-forum-tasks-20260816-static-v1.3.zip.sha256
release_root=/var/www/.mkj-community-releases
current=/var/www/MKJ
expected_release=20260816
...
backup="$release_root/${stamp}.before-v1.3.tar.gz"

sudo install -d -m 0755 "$release_root" "$stage"
sudo unzip -q "$artifact" -d "$stage"

for required in RELEASE-MANIFEST.txt index.html tasks/index.html tasks/create/index.html tasks/detail/index.html tasks/my/index.html admin/tasks/index.html assets/js/tasks/task-api.js assets/js/tasks/task-detail.js; do
